...
ClapTrap::ClapTrap() : name("default") , hitPoints(100) , energyPoints(50), damageAttack(0) {
    std::cout << "ClapTrap Default contrustor called." << std::endl;
}

ClapTrap::ClapTrap(std::string Name ) : name(Name) , hitPoints(100) , energyPoints(50), damageAttack(0) {
